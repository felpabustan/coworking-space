...
class bs4Navwalker extends Walker_Nav_Menu
{
    ...
    public function start_lvl( &$output, $depth = 0, $args = array() ) {
        ...
        $output .= "\n$indent<div class=\"dropdown-menu bg-dark border-0 shadow-md px-3\">\n";
    }
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if (in_array('current-menu-item', $classes)) {
            $class_names .= ' active border-b-4 border-golden-grass-400 text-golden-grass-400';
        }
        //
        ...
        if ($depth > 0) {
            $manual_class = array_values($classes)[0] .' '. 'dropdown-item px-0 my-1';
        ...
        /*
        if ($depth === 0 && in_array('menu-item-has-children', $classes)) {
            $item_output .= '<a class="nav-link dropdown-toggle"' . $attributes .'data-bs-toggle="dropdown">';
        } elseif ($depth === 0) {
