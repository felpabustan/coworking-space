...
define('CAPTCHA_DATA_SITE_KEY', '6Lfp6DcqAAAAAFeCwtrvyYEKoiqz6kJ2dVPUrMo6');
define('CAPTCHA_SECRET', '6Lfp6DcqAAAAACCJDPZ0inm0HDmTNxn0xD9vQTe7');
...
function display_booking_form() {
    ...
    <form class="grid grid-cols-1 gap-5" id="booking-form" method="post" action="submit_booking">
        ...
        <!-- <div id="recaptchaCheckbox" class="g-recaptcha" data-sitekey="<?php //echo CAPTCHA_DATA_SITE_KEY?>" style="padding-top: 20px;"></div> -->
        <!-- Submit Button -->
...
function handle_booking_form_submission() {
  ...
  //   $verification = verifyRecaptcha($_POST['g-recaptcha-reponse']);
...
function verifyRecaptcha($gRecaptchaResponse) {
  ...
  return json_decode($recaptcha_result, true);
}